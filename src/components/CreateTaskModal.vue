...
<div>
  <base-modal
        ...
        :size="true"
        @closeModal="toggleCloseModalCreate()"
      >
              ...
              <div class="card-body">
                <form class="form-sample">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 add-user" v-if="users.length > 0">
                      <div class="form-group row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-6 containers">
                          ...
                          ></span>
                          <div class="list-select" v-if="openListSelect">
                            <ul>
                              <li
                                v-for="(cus, i) in customers"
                                :key="i"
                                :class="{
                                  selected: customer && cus.id == customer.id,
                                }"
    ...
    async toggleCreate() {
      ...
      await axios({
        ...
        .then((res) => {
          ...
          this.$emit('open-task', res.data.task.id);
          this.$emit('update');
